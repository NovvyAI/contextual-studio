...
6. 视频为最多 3 个独立镜头任务，每镜 4-15 秒、9:16、720p；Novvy 使用 seedance-2.0-fast，ImaRouter 使用 seedance-2.0。所有生成画面文字、CTA、对白、旁白和语音使用英文。内容镜头完成后由后端拼接，并确定性追加已确认原始落版图；不要要求视频模型重绘落版文字。
